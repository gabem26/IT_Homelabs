...
| [Notifications](./Active_Directory/Notifications/) | Automated email alerts for password expiry and account lockouts | PowerShell, AD queries, SMTP/email automation, scheduled alerting, admin + user notification logic |
